...
insert into user (id, email, password, nickname, regdate) VALUES (4, 'bee', '{bcrypt}$2a$10$qS48/8nM2fSagy1di.whF.tutE/VZ9/wwOkGBcm.Ty8mOKLfwpv/G', '땡벌', now());
...
insert into user_roles(id, role_name, user_id) VALUES (5, 'USER', 4);

insert into channel(id, name, type, regdate) VALUES (1, 'general', 'public', now());
insert into channel_user(id, user_id, channel_id, regdate) VALUES (1, 1, 1, now());
insert into channel_user(id, user_id, channel_id, regdate) VALUES (2, 2, 1, now());
insert into channel_user(id, user_id, channel_id, regdate) VALUES (3, 4, 1, now());
