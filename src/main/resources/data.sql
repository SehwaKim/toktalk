...
insert into user (id, email, password, nickname, regdate ,user_status) VALUES (2, 'piakatie@naver.com', '{bcrypt}$2a$10$qS48/8nM2fSagy1di.whF.tutE/VZ9/wwOkGBcm.Ty8mOKLfwpv/G', '갈색곰', now(),'NORMAL');
...
insert into messages(id,text,user_id,nickname,channel_id,regdate) values (4,'안뇽',1,'아이스베어',1,now());
insert into messages(id,text,user_id,nickname,channel_id,regdate) values (5,'안뇽',1,'아이스베어',1,now());
insert into messages(id,text,user_id,nickname,channel_id,regdate) values (6,'안뇽',1,'아이스베어',1,now());
